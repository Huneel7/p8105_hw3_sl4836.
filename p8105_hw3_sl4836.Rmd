...
This is a spaghetti plot that shows a line of the average BRFSS data value over time within a state from 2002 to 2010. It's hard to say if there are apparent trends across states between 2002 and 2010. One thing to be observed is that the average BRFSS data values of the states are relatively high in 2002. 
